...
const CONTENT_TYPE_ITEM_TITLE: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_ITEM_META_DESCRIPTION: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_ITEM_H1_TITLE: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
    input_label: "Title",
    input_classname: "inp_1 grow",
...
const CONTENT_TYPE_ITEM_LEAD: ContentTypeField = {
    input_type: "textarea",
...
const CONTENT_TYPE_ITEM_BODY: ContentTypeField = {
    input_type: "textarea",
...
const CONTENT_TYPE_SLUG_ITEM: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_CATEGORY_ID_ITEM: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
    input_label: "Category id",
    input_classname: "inp_1 grow",
    input_id: "sk-category-id",
    input_description: "aZ-09, no whitespace",
    data_namespace: "sk",
    isRequired: true
}
...
const CONTENT_TYPE_ITEM_POST_CATEGORY_ID: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
    input_label: "Category id",
    input_classname: "inp_1 grow",
    input_id: "post_category_id",
    input_description: "aZ-09, no whitespace",
    data_namespace: "category_id",
    isRequired: true
}


const CONTENT_TYPE_ITEM_POST_CATEGORY_NAME: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
    input_label: "Category name",
    input_classname: "inp_1 grow",
    input_id: "post_category name",
    input_description: "display name",
    data_namespace: "category_name",
    isRequired: true
}

// ---

const CONTENT_TYPE_ITEM_POST_AUTHOR_NAME: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_ITEM_POST_AUTHOR_URL: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_ITEM_CATEGORY: ContentTypeField = {
    input_type: "list",
    input_label: "Category",
    input_id: "article_category",
    input_description: "Article fits into this categories",
    data_namespace: "categories",
    data_type: 'list',
    list_config: [{
        item_namespace: "category_id",
        input_type: "text",
        input_label: "Category id (for DB queries)",
    },
    {
        item_namespace: "category_name",
        input_type: "text",
        input_label: "Category name (displayed)",
    }],
}
...
const CONTENT_TYPE_ITEM_SCHEMA_ORG_ARTICLE_TYPE: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_ITEM_MAIN_KEYWORD: ContentTypeField = { // OKK
    data_type: "string",
    input_type: "text",
...
const CONTENT_TYPE_ITEM_BLOG_POST_FEED_PREVIEW_IMAGE: ContentTypeField = {
    ...
    custom_config: {
        ...
        //        data_keys: ["src", "width", "height", "alt", "loading"],
        //  select_items: null,
        // placeHolder: null
    }
}
...
const CONTENT_TYPE_ITEMS_BLOG_POST_CATEGORY = {
    group_title: "Post category",
    group_description: "Blog post category",
    children: [
        CONTENT_TYPE_ITEM_POST_CATEGORY_ID,
        CONTENT_TYPE_ITEM_POST_CATEGORY_NAME

    ]
}


//const CONTENT_TYPE_ITEMS_BLOG_POST_KEYWORDS = {
//    group_title: "Keywords",
//    group_description: "used for as schema.org markup",
//    children: [
//
//        CONTENT_TYPE_ITEM_MAIN_KEYWORD,
//        CONTENT_TYPE_ITEM_ADDITIONAL_KEYWORDS
...
const CONTENT_TYPE_ITEMS_ASIDE = {
    ...
    group_description: "",
    children: [
        //        CONTENT_TYPE_ITEM_ASIDE_RELATED_POSTS
...
const CONTENT_TYPE_BLOG_POST = {
    ...
    children: [
        ...
        //  CONTENT_TYPE_ITEMS_BLOG_POST_KEYWORDS,
        CONTENT_TYPE_ITEMS_BLOG_AUTHOR,
        CONTENT_TYPE_ITEMS_BLOG_POST_CATEGORY,
...
// const CONTENT_TYPE_CATEGORY_FAQ = {
//     type_namespace: "CF",
//     type_label: "Category FAQ",
//     children: [
//         CONTENT_TYPE_ITEMS_GROUP_FAQ_BLOCK
// 
//     ]
